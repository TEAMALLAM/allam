...
print('\n\27[1;36m￤تم آدخآل آيدي آلمـطـور بنجآح , سـوف يتم تشـغيل سورس علام الان .\n￤Success Save ID : \27[0;32m['..SUDO_USER..']\n\27[0;39;49m')
boss = Token:match("(%d+)")
redis:mset(
boss..":VERSION","1.0",
...
▀
▄█████████▀           ██               ██             ██                    ██▄████████▀ │BATSHICO ﹏ @FACKYOOOOOU
│
تم تطوير وبرمجة السورس من قبل علام
│@FACKYOOOOOU
...
if msg.sender_user_id_ == 1859656976 then 
...
SUDO_USER = redis:hgetall(boss..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(boss..':WELCOME_BOT'),[[• مرحباً انا بوت ]]..redis:get(boss..':NameBot:')..[[ .
...
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1859656976) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل ") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1859656976) then
