...
if UserID == 1859656976 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID ==  1859656976 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
local inline = {{{text="قناه‏‏ السـورس : علام ",url="t.me/source_allam"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: علام](t.me/source_allam)',nil,inline,msg.id_)
return false
end
...
local inline = {
{{text = '-𝐃𝐄𝐕 👑',url="https://t.me/FACKYOOOOOU"}},
}   
...
local inline = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝘽𝘼𝙕𝘼 ⩫ ',url="https://t.me/source_allam"}},
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا الحساب محظور من سيرفرات حماية علام ") end
...
if msg.adduser == 1859656976 then 
gtupe = 'مطور السورس' 
...
elseif Text== "علام " or Text== "علومتي" or Text== "علم" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس👑](T.ME/FACKYOOOOOU")
